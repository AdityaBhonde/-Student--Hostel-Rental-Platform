...
<div class="container">
                ...
                if ($total != 0) {
                    ...
                    <td>" . $result['seat_availability'] . "</td>";
                        echo "<td><form method='POST' ><input name='id1' type='hidden' value='$id'><button type='submit' class='btn btn-danger'  name='submit' >DELETE</button></form></td>";
                        echo "</tr>";
                    }
                } else {
                ...
                if (isset($_POST['submit'])) {
                    $flitervalue = $_POST['id1'];
                    $sql = "DELETE FROM hostels WHERE hostel_id='$flitervalue'";
