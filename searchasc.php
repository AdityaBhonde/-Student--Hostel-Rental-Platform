    ...
    <form action=""method ="GET">
       ...
       <?php
        ...
        if(isset($_GET['search'])){
            ...
            $query="SELECT * FROM hostels WHERE CONCAT(hostel_name,hostel_id,city,state) LIKE '%$flitervalue%' ORDER BY fee_single ASC";
       ...
       ?>
       <form method="POST"> <button type="submit" name="submit" value="<?php if (isset($_POST['submit']))?>"SEND</button> </form>
       <?php
        include("connection.php");
